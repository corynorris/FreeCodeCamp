var quotes = [
    ...
    ["I have not failed. I've just foun,[ays that won't work.", "Thomas A. Edison"],
...
var animation = "animated slideInLeft";

$("#quote-block").children().bind("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
    function() {
        $("#quote-block").children().removeClass(animation);
    });
